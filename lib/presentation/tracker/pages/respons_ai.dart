...
class _HistoryTrackerState extends State<HistoryTracker> {
  ...
  Future<void> _getAIResponse() async {
    ...
    // Respons dummy dari API
    final response =
        "Terdengar seperti kamu sedang menghadapi banyak hal, dan pasti sangat melelahkan. Ingat, kamu tidak sendiri.";

    setState(() {
      _aiResponse = response; // Simpan respons
